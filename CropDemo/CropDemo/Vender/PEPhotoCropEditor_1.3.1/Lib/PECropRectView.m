...
- (void)setFreezeSize:(BOOL)freezeSize
{
    ...
    self.topLeftCornerView.freeze =
    self.topRightCornerView.freeze =
    self.bottomLeftCornerView.freeze =
    self.bottomRightCornerView.freeze =
    self.topEdgeView.freeze =
    self.leftEdgeView.freeze =
    self.bottomEdgeView.freeze =
    self.rightEdgeView.freeze = freezeSize;
}
